...
# Set the metadata files url based on GitLab v4 API (also specify the commit ID!)
...
system(paste0("wget -r --no-parent -e robots=off -l1 -nd -A 'MoGene-1_0-st-v1.r4.*.zip' https://media.affymetrix.com/analysis/downloads/lf/wt/ -P ", here("data/platform_files", platform.id)))
```
